...
<header>
    ...
    <div class="banner text-center text-white py-5"
         style="background-image: url('billeder/cloth4.jpg'); background-size: cover; background-position: center; height: 300px;">
        <h1>Velkommen til</h1>
        <h1>Re-trade</h1>
...
<main>
    <section id="landing-page" class="text-center py-4">
        ...
        <p>Re-Trade inviterer dig til bæredygtige tøjbytte-events på Tapperiet i Køge. Hver første søndag i måneden kan
            du bytte tøj,
            sko og accessories, du ikke længere bruger, og finde nye favoritter – helt gratis. Sammen skaber vi et
            grønnere fællesskab og giver tøjet nyt liv.</p>
    </section>
    ...
    <section id="features" class="text-center">
        <p><strong>Tøjbytte for alle:</strong> Tag tøj, sko og accessories med, og byt med andre deltagere. Du bestemmer
            selv, hvad du vil bytte og med hvem.</p>
        <p><strong>Standområder med lokale butikker:</strong> Lokale butikker fra Køge sælger deres restvarer til stærkt
            nedsatte priser.</p>
    ...
    <section id="about" class="container text-center custom-margin">
        <div class="row row-cols-2">
            ...
            <div class="col mt-4">
                <p>Re-Trade er en bæredygtig bevægelse skabt for at mindske forbruget og styrke fællesskabet i Køge
                    Kommune.
                    Vi tror på, at små skridt kan føre til store forandringer, og vores tøjbytte-events er en nem og
                    sjov måde at tage ansvar for miljøet på.</p>
            </div>
            <div class="col mt-3">
                <p>Vores månedlige events på Tapperiet er meget mere end bare tøjbytte. De er en anledning til at møde
                    nye mennesker,
                    dele gode historier og opdage skjulte skatte blandt andres glemte tøj. Derudover har vi skabt en
                    platform, hvor lokale butikker kan sælge deres restvarer til fordelagtige priser, så intet går til
                    spilde.</p>
            </div>
